...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative">
      ...
      <div className="glass rounded-3xl p-10 max-w-sm w-full text-center relative overflow-hidden noise">
        {/* Logo */}
        ...
        <h1 className="text-2xl font-display font-bold text-white mb-2">LingoForge</h1>
        <p className="text-sm text-slate-400 mb-8 leading-relaxed">
          Master Spanish, French & Dutch through<br />
        ...
        <button
          ...
          disabled={signingIn}
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white hover:bg-gray-50 disabled:opacity-70 text-slate-800 font-semibold rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl"
        >
          {signingIn ? (
